...
public class UpdateDocument extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String idFolderS = request.getParameter("folderId");
		
		int idFolder = Integer.parseInt(idFolderS);
		int idDocument = Integer.parseInt(documentIdS);
		
		DocumentDAO documentDAO = new DocumentDAO(connection);
		
		try {
			documentDAO.updateDocument(idDocument, idFolder);
		} catch (SQLException e) {
